# -*- coding: utf-8 -*-
"""
Created on Sat Oct 19 11:49:49 2019
...
# ======= load dataset =======
dataset_file = "datasets/Price data/ORCL/9-micro-2.0y.csv"

dataset      = pandas.read_csv(dataset_file, usecols=[1,2,3,4,5,7])
...
print(x_train_total)
'''
x_t, y_t        =  build_timeseries(x_train, 5)
...
#x_test reshaped
x_temp, y_temp  =  build_timeseries(x_test, 5)
