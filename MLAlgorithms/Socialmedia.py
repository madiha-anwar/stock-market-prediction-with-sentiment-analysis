...
# ========================= load dataset =====================================
dataset_file = "datasets/Social media/ORCL/10-micro-2.0y.csv"
...
#dataset[['NewsSentiment']] = dataset[['NewsSentiment']].replace(0, numpy.NaN)
...
pipelines = []
pipelines.append(('GNB', Pipeline([('Scaler', StandardScaler()),('GNB',
GaussianNB())])))
    
pipelines.append(('MNB', Pipeline([('Scaler', MinMaxScaler()),('MNB',
MultinomialNB())])))
...
print("\n==================== Accuracies ====================")
print("\nGNB Accuracy: %s" % round(gnb_accuracy,2))
print("\nMNB Accuracy: %s" % round(mnb_accuracy,2))
print("\nSVM Accuracy: %s" % round(svm_accuracy,2))
print("\nLR Accuracy: %s" % round(lr_accuracy,2))
